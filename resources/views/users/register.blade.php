...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Nouvelle école</h5>
                <div class="card-body">
                    @if (session('success'))
                    ...
                    @endif
                    {!! Form::open(['url' => '/ben/sms/users/store']) !!}
                       @csrf
                        <div class="form-group row">
                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Nom d'utilisateur</label>
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input name="username" type="text" required="true" placeholder="Username" class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input name="school_name" type="text" required="true" data-parsley-minlength="8" placeholder="Nom de l'école" class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input name="email" type="email" required="true" data-parsley-type="email" placeholder="Entrer un e-mail valide" class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input name="phone_number" data-parsley-type="digits" type="tel" required="true" placeholder="Doit commencer par 229" class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input name="address"  type="text" required="true" placeholder="Adresse" class="form-control">
